...
public struct SomeType {
    ...
    internal var internalComputedPropeerty: Int {
        get {
            return count
        }
...
// 오류발생: Cannot assign to property: 'publicGetOnlyStoredProperty' setter is inaccessible

// 외부에서 접근자, 설정자 모두 사용 가능
print(someInstance.internalComputedPropeerty) // 0
someInstance.internalComputedPropeerty = 100

// 외부에서 접근자만 사용 가능
print(someInstance.internalGetOnlyComputedProperty) // 1
//someInstance.internalGetOnlyComputedProperty = 100
// 오류발생: Cannot assign to property: 'internalGetOnlyComputedProperty' setter is inaccessible
